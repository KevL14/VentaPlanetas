...
`;  
  ...
  nav.addEventListener('click', e => {
    ...
    const btnSettings = e.target.closest('#settingsNav');
    ...
    else if (btnSettings) location.hash = '/adminCrudsPages';
  });
 ...
 setTimeout(() => {
  ...
  const settingsBtn = nav.querySelector('#settingsNav');
